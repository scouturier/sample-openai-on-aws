...
from codex_with_bedrock.cli.commands.init import validate_cognito_user_pool_id, validate_identity_pool_name
...
class TestNamedValidationFunctions:
    ...
    def test_validate_identity_pool_name_valid(self):
        ...
        valid_names = ["codex-auth", "my_identity_pool", "test123", "UPPERCASE", "Mixed_Case-123"]
...
class TestInitCommandRegression:
    ...
    def test_no_duplicate_imports(self):
        ...
        init_file_path = (
            Path(__file__).parent.parent.parent.parent / "codex_with_bedrock" / "cli" / "commands" / "init.py"
        )
    ...
    def test_lambda_functions_can_access_re(self):
        ...
        import codex_with_bedrock.cli.commands.init as init_module
