...
class TestSelectedModelField:
    ...
    def test_selected_model_field_exists(self):
        ...
        assert profile.selected_model == "openai.gpt-oss-120b"
    ...
    def test_to_dict_includes_selected_model(self):
        ...
        assert result["selected_model"] == "openai.gpt-oss-120b"
        assert result["cross_region_profile"] == "us"

    def test_all_bedrock_models(self):
        """Test that all Bedrock model IDs are valid."""
        model_ids = [
            "openai.gpt-oss-120b",
        ]
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch.object(Config, "CONFIG_FILE", config_file):
                with patch.object(Config, "CONFIG_DIR", Path(tmpdir)):
                    ...
                    assert loaded_profile.selected_model == "openai.gpt-oss-120b"
