...
class TestCoreModuleImports:
    ...
    @pytest.mark.parametrize(
        "module_path",
        [
            "codex_with_bedrock.config",
            "codex_with_bedrock.models",
            "codex_with_bedrock.quota_policies",
            "codex_with_bedrock.validators",
            "codex_with_bedrock.migration",
            "codex_with_bedrock.cli",
            "credential_provider",
        ],
    )
...
class TestCommandImports:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("codex_with_bedrock.cli.commands.init", ["InitCommand"]),
            ("codex_with_bedrock.cli.commands.deploy", ["DeployCommand"]),
            ("codex_with_bedrock.cli.commands.destroy", ["DestroyCommand"]),
            ("codex_with_bedrock.cli.commands.status", ["StatusCommand"]),
            ("codex_with_bedrock.cli.commands.cleanup", ["CleanupCommand"]),
            ("codex_with_bedrock.cli.commands.package", ["PackageCommand"]),
            ("codex_with_bedrock.cli.commands.distribute", ["DistributeCommand"]),
            ("codex_with_bedrock.cli.commands.test", ["TestCommand"]),
            (
                "codex_with_bedrock.cli.commands.context",
                [
                    "ContextListCommand",
            ...
            ("codex_with_bedrock.cli.commands.builds", ["BuildsCommand"]),
            (
                "codex_with_bedrock.cli.commands.quota",
                [
                    "QuotaSetUserCommand",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("codex_with_bedrock.cli.commands.distribute", "DistributeCommand"),
            ("codex_with_bedrock.cli.commands.test", "TestCommand"),
            ("codex_with_bedrock.cli.commands.context", "ContextListCommand"),
            ("codex_with_bedrock.cli.commands.context", "ContextCurrentCommand"),
            ("codex_with_bedrock.cli.commands.context", "ContextUseCommand"),
            ("codex_with_bedrock.cli.commands.context", "ContextShowCommand"),
            ("codex_with_bedrock.cli.commands.context", "ConfigValidateCommand"),
            ("codex_with_bedrock.cli.commands.context", "ConfigExportCommand"),
            ("codex_with_bedrock.cli.commands.context", "ConfigImportCommand"),
            ("codex_with_bedrock.cli.commands.builds", "BuildsCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaSetUserCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaSetGroupCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaSetDefaultCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaListCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaDeleteCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaShowCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaUsageCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaUnblockCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaExportCommand"),
            ("codex_with_bedrock.cli.commands.quota", "QuotaImportCommand"),
        ],
    )
    ...
    def test_cli_main_import(self):
        ...
        which is what happens when a user runs 'cxwb' command.
        """
        try:
    ...
    def test_all_quota_commands_registered(self):
        ...
        """
        from codex_with_bedrock.cli.commands.quota import (
            QuotaDeleteCommand,
            QuotaExportCommand,
            QuotaImportCommand,
            QuotaListCommand,
...
class TestCommandDefinitions:
    ...
    def test_quota_export_argument_syntax(self):
        ...
        """
        from codex_with_bedrock.cli.commands.quota import QuotaExportCommand
    ...
    def test_all_commands_have_valid_definitions(self):
        ...
        """
        from codex_with_bedrock.cli.commands import (
            builds,
            cleanup,
            context,
            deploy,
