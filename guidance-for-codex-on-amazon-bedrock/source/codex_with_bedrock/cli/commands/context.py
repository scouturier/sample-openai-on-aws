...
from codex_with_bedrock.validators import ProfileValidator
    ...
    def handle(self) -> int:
        ...
        try:
            ...
            if not profiles:
                ...
                console.print("Run [cyan]cxwb init[/cyan] to create your first profile.\n")
                return 0
            ...
            if config.active_profile:
                ...
                console.print("Use [cyan]cxwb context use <profile>[/cyan] to set one.\n")
    ...
    def handle(self) -> int:
        ...
        try:
            ...
            if profile_name not in config.list_profiles():
                ...
                console.print("\nUse [cyan]cxwb context list[/cyan] to see all profiles.\n")
                return 1
        ...
        try:
            ...
            if not profile_name:
                ...
                if not profile_name:
                    ...
                    console.print("Use [cyan]cxwb context show <profile>[/cyan] or set an active profile.\n")
                    return 1
    ...
    def handle(self) -> int:
        ...
        try:
            ...
            # Validate single profile
                ...
                if not profile_name:
                    console.print("\n[red]No active profile set and no profile specified.[/red]")
                    console.print("Use [cyan]cxwb config validate <profile>[/cyan] or set an active profile.\n")
                    return 1
    ...
    def handle(self) -> int:
        ...
        try:
            ...
            if not profile_name:
                ...
                if not profile_name:
                    console_err.print("\n[red]No active profile set and no profile specified.[/red]")
                    console_err.print("Use [cyan]cxwb config export <profile>[/cyan] or set an active profile.\n")
                    return 1
    ...
    def handle(self) -> int:
        ...
        try:
            ...
            if profile_name:
                ...
                console.print(f"Use [cyan]cxwb config import {file_path} <name>[/cyan] to specify a name.\n")
                return 1
            ...
            console.print(f"[dim]Profile saved to: ~/.cxwb/profiles/{profile_name}.json[/dim]\n")
