...
class BuildsCommand(Command):
    ...
    def handle(self) -> int:
        ...
        try:
            ...
            console.print("  poetry run cxwb builds --status <build-id>")
            console.print("\n[dim]To download completed Windows artifacts:[/dim]")
            console.print("  poetry run cxwb builds --status latest --download")
            console.print("\n[dim]To start a new build:[/dim]")
            console.print("  poetry run cxwb package --target-platform windows")
            ...
            if status == "IN_PROGRESS":
                ...
                if self.option("download"):
                    ...
                    if not target_dir:
                        ...
                        console.print("[yellow]Run 'poetry run cxwb package' first to create a package[/yellow]")
                        return 1
                    ...
                    console.print("\n  Or run: [cyan]poetry run cxwb builds --status latest --download[/cyan]")
