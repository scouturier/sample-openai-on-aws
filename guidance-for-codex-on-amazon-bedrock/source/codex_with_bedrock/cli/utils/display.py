...
from codex_with_bedrock.models import get_all_model_display_names
...
def _display_table_format(console: Console, profile, identity_pool_id: str | None) -> None:
    ...
    config_table.add_row("AWS Profile", "Codex")
    ...
    if selected_model:
        ...
        config_table.add_row("Bedrock Model", model_names.get(selected_model, selected_model))
...
def _display_simple_format(console: Console, profile, identity_pool_id: str | None) -> None:
    ...
    console.print("  AWS Profile: [cyan]Codex[/cyan]")
    ...
    if selected_model:
        ...
        console.print(f"  Bedrock Model: [cyan]{model_display}[/cyan]")
