# ABOUTME: Configuration management for Codex with Bedrock
# ABOUTME: Handles profiles, settings persistence, and configuration validation

"""Configuration management for Codex with Bedrock."""
...
class Profile:
    ...
    metrics_log_group: str = "/aws/codex/metrics"
    ...
    selected_model: str | None = None  # Selected Bedrock Mantle model ID (e.g., "openai.gpt-5.4")
    selected_source_region: str | None = None  # User-selected source region for AWS config and Codex settings
...
class Config:
    """Configuration manager for Codex with Bedrock."""

    # New location in user home directory
    CONFIG_DIR = Path.home() / ".cxwb"
    CONFIG_FILE = CONFIG_DIR / "config.json"
    PROFILES_DIR = CONFIG_DIR / "profiles"

    # Legacy location for migration
    LEGACY_CONFIG_DIR = Path(__file__).parent.parent / ".cxwb-config"
